...
\begin{onecolentry}
    My planned research aims to leverage over two decades of professional experience in the IT industry to explore historical perspectives on the Pascal programming language.
...
\begin{onecolentry}
    \begin{highlights}
        \item Rebuilt the initial cloud infrastructure, employing infrastructure-as-code and reducing costs by 50\%.
...
\begin{twocolentry}[7.5cm]{ % MODIFIED: Provide a custom width for the second column, e.g., 7.5cm
        \textit{Lisbon, Portugal \& Stuttgart, Germany}
