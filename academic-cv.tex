...
\begin{onecolentry}
    \begin{highlights}
        ...
        \item Conducted research and practical work for graduation thesis entitled \textit{"Multi-Channel Support for WebSphere Business Process Choreographer: Form-Based Offline Work with Processes and Tasks"}.
    \end{highlights}
\end{onecolentry}
