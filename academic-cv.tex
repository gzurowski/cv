...
\begin{onecolentry}
    \begin{highlights}
        ...
        \item Rebuilt cloud infrastructure using infrastructure-as-code, achieving a 50\% reduction in operational costs.
        \item Established CI/CD principles and pipelines, which enhanced deployment efficiency and reliability.
...
\begin{onecolentry}
    \begin{highlights}
        ...
        \item Responsible for designing and generating domain models following a model-driven architecture approach.
...
\begin{onecolentry}
    \begin{highlights}
        ...
        \item Operated and implemented performance improvements for Oracle databases.
    \end{highlights}
\end{onecolentry}
...
\begin{onecolentry}
    \begin{highlights}
        \item Developed a network discovery system interfacing with central asset management systems.
