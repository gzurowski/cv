...
\begin{onecolentry}
    \begin{highlights}
        \item Developed features for research fundraising, grants, peer review management, and article publication.
...
\begin{onecolentry}
    \begin{highlights}
        \item Designed and implemented a microservices architecture supporting Sotheby's digital transformation.
        \item Built a custom e-commerce platform from scratch, enabling the successful launch of a new retail division.
        ...
        \item Prototyped a message-oriented integration architecture to connect different core backend systems.
    \end{highlights}
\end{onecolentry}
...
\begin{samepage}
    \begin{twocolentry}[3.5cm]{
            \textit{Washington, D.C.}
...
\begin{onecolentry}
    \textbf{German} (Native), \textbf{English} (Professional Working Proficiency), \textbf{Polish} (Elementary Proficiency)
\end{onecolentry}
