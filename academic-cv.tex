...
\begin{onecolentry}
    \begin{highlights}
        ...
        \item Developed foundational microservices using AWS and Cloud Foundry to enable platform scalability.
        \item Established and mentored engineering teams in Portugal to deliver Java-based systems.
    \end{highlights}
\end{onecolentry}
