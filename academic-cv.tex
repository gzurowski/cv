...
\begin{onecolentry}
    ...
    Key interest include investigating Pascal's role as a response to the complexities of ALGOL 68, exploring Pascal's influence on programming education and early home computing, and examining the business history of the Borland Software Corporation through the lens of its Pascal implementation.
\end{onecolentry}
